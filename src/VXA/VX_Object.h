...
public:
	...
	int GetDataPointCount(void) {return DStrain.size();}
	vfloat GetStressData(int DataIndex) {return DStress[DataIndex];}
	vfloat GetStrainData(int DataIndex) {return DStrain[DataIndex];}
